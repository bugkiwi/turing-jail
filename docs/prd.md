...
> 本版在原"人类越狱"设计基础上更新：项目更名为 **Turing Jail**，新增数字 ID 身份系统、通关成功率排行榜、分享卡整合、中英德三语言支持，技术栈调整为 Bun + Hono + Vercel Edge + Neon；本次补充：按视觉稿同步机械闸门锁核心交互、全局 HUD 栏、音效设计与视觉基调（详见第 7 节）。
