...
export const copy = {
  zh: {
    ...
    sharedRecord: '封存结果',
    shareLoading: '正在读取封存记录……',
    shareUnavailable: '这份封存记录不存在，或仍未完成三关。',
    live: '实时评估',
    quickInfo: '由 TypeSafe Jev System One 提供结构化 AI 评估。',
    final: '最终判决',
  ...
  en: {
    ...
    locked: '[HARD LOCK] HYDRAULIC BOLTS ENGAGED',
    ...
    sharedRecord: 'SEALED RECORD',
    shareLoading: 'READING SEALED RECORD…',
    shareUnavailable: 'This sealed record does not exist or the three-level run is incomplete.',
    live: 'LIVE EVAL',
    quickInfo: 'Structured AI evaluation powered by TypeSafe Jev System One.',
    final: 'FINAL VERDICT',
  ...
  de: {
    ...
    locked: '[HARTSPERRE] HYDRAULIKBOLZEN VERZAHNT',
    ...
    sharedRecord: 'VERSIEGELTE AKTE',
    shareLoading: 'VERSIEGELTE AKTE WIRD GELESEN…',
    shareUnavailable: 'Diese versiegelte Akte existiert nicht oder der Lauf ist noch nicht abgeschlossen.',
    live: 'LIVE-PRÜFUNG',
    quickInfo: 'Strukturierte KI-Bewertung mit TypeSafe Jev System One.',
    final: 'ENDGÜLTIG',
